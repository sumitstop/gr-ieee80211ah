...
const std::complex<double> QAM256_D[256] = {
		std::complex<double>(-1.1538, -1.1538), std::complex<double>(-1.1538, -1.0000),
		std::complex<double>(-1.1538, -0.8462), std::complex<double>(-1.1538, -0.6923),
		std::complex<double>(-1.1538, -0.5385), std::complex<double>(-1.1538, -0.3846),
		std::complex<double>(-1.1538, -0.2308), std::complex<double>(-1.1538, -0.0769),
		std::complex<double>(-1.1538, 1.1538), std::complex<double>(-1.1538, 1.0000),
		std::complex<double>(-1.1538, 0.8462), std::complex<double>(-1.1538, 0.6923),
		std::complex<double>(-1.1538, 0.5385), std::complex<double>(-1.1538, 0.3846),
		std::complex<double>(-1.1538, 0.2308), std::complex<double>(-1.1538, 0.0769),
		std::complex<double>(-1.0000, -1.1538), std::complex<double>(-1.0000, -1.0000),
		std::complex<double>(-1.0000, -0.8462), std::complex<double>(-1.0000, -0.6923),
		std::complex<double>(-1.0000, -0.5385), std::complex<double>(-1.0000, -0.3846),
		std::complex<double>(-1.0000, -0.2308), std::complex<double>(-1.0000, -0.0769),
		std::complex<double>(-1.0000, 1.1538), std::complex<double>(-1.0000, 1.0000),
		std::complex<double>(-1.0000, 0.8462), std::complex<double>(-1.0000, 0.6923),
		std::complex<double>(-1.0000, 0.5385), std::complex<double>(-1.0000, 0.3846),
		std::complex<double>(-1.0000, 0.2308), std::complex<double>(-1.0000, 0.0769),
		std::complex<double>(-0.8462, -1.1538), std::complex<double>(-0.8462, -1.0000),
		std::complex<double>(-0.8462, -0.8462), std::complex<double>(-0.8462, -0.6923),
		std::complex<double>(-0.8462, -0.5385), std::complex<double>(-0.8462, -0.3846),
		std::complex<double>(-0.8462, -0.2308), std::complex<double>(-0.8462, -0.0769),
		std::complex<double>(-0.8462, 1.1538), std::complex<double>(-0.8462, 1.0000),
		std::complex<double>(-0.8462, 0.8462), std::complex<double>(-0.8462, 0.6923),
		std::complex<double>(-0.8462, 0.5385), std::complex<double>(-0.8462, 0.3846),
		std::complex<double>(-0.8462, 0.2308), std::complex<double>(-0.8462, 0.0769),
		std::complex<double>(-0.6923, -1.1538), std::complex<double>(-0.6923, -1.0000),
		std::complex<double>(-0.6923, -0.8462), std::complex<double>(-0.6923, -0.6923),
		std::complex<double>(-0.6923, -0.5385), std::complex<double>(-0.6923, -0.3846),
		std::complex<double>(-0.6923, -0.2308), std::complex<double>(-0.6923, -0.0769),
		std::complex<double>(-0.6923, 1.1538), std::complex<double>(-0.6923, 1.0000),
		std::complex<double>(-0.6923, 0.8462), std::complex<double>(-0.6923, 0.6923),
		std::complex<double>(-0.6923, 0.5385), std::complex<double>(-0.6923, 0.3846),
		std::complex<double>(-0.6923, 0.2308), std::complex<double>(-0.6923, 0.0769),
		std::complex<double>(-0.5385, -1.1538), std::complex<double>(-0.5385, -1.0000),
		std::complex<double>(-0.5385, -0.8462), std::complex<double>(-0.5385, -0.6923),
		std::complex<double>(-0.5385, -0.5385), std::complex<double>(-0.5385, -0.3846),
		std::complex<double>(-0.5385, -0.2308), std::complex<double>(-0.5385, -0.0769),
		std::complex<double>(-0.5385, 1.1538), std::complex<double>(-0.5385, 1.0000),
		std::complex<double>(-0.5385, 0.8462), std::complex<double>(-0.5385, 0.6923),
		std::complex<double>(-0.5385, 0.5385), std::complex<double>(-0.5385, 0.3846),
		std::complex<double>(-0.5385, 0.2308), std::complex<double>(-0.5385, 0.0769),
		std::complex<double>(-0.3846, -1.1538), std::complex<double>(-0.3846, -1.0000),
		std::complex<double>(-0.3846, -0.8462), std::complex<double>(-0.3846, -0.6923),
		std::complex<double>(-0.3846, -0.5385), std::complex<double>(-0.3846, -0.3846),
		std::complex<double>(-0.3846, -0.2308), std::complex<double>(-0.3846, -0.0769),
		std::complex<double>(-0.3846, 1.1538), std::complex<double>(-0.3846, 1.0000),
		std::complex<double>(-0.3846, 0.8462), std::complex<double>(-0.3846, 0.6923),
		std::complex<double>(-0.3846, 0.5385), std::complex<double>(-0.3846, 0.3846),
		std::complex<double>(-0.3846, 0.2308), std::complex<double>(-0.3846, 0.0769),
		std::complex<double>(-0.2308, -1.1538), std::complex<double>(-0.2308, -1.0000),
		std::complex<double>(-0.2308, -0.8462), std::complex<double>(-0.2308, -0.6923),
		std::complex<double>(-0.2308, -0.5385), std::complex<double>(-0.2308, -0.3846),
		std::complex<double>(-0.2308, -0.2308), std::complex<double>(-0.2308, -0.0769),
		std::complex<double>(-0.2308, 1.1538), std::complex<double>(-0.2308, 1.0000),
		std::complex<double>(-0.2308, 0.8462), std::complex<double>(-0.2308, 0.6923),
		std::complex<double>(-0.2308, 0.5385), std::complex<double>(-0.2308, 0.3846),
		std::complex<double>(-0.2308, 0.2308), std::complex<double>(-0.2308, 0.0769),
		std::complex<double>(-0.0769, -1.1538), std::complex<double>(-0.0769, -1.0000),
		std::complex<double>(-0.0769, -0.8462), std::complex<double>(-0.0769, -0.6923),
		std::complex<double>(-0.0769, -0.5385), std::complex<double>(-0.0769, -0.3846),
		std::complex<double>(-0.0769, -0.2308), std::complex<double>(-0.0769, -0.0769),
		std::complex<double>(-0.0769, 1.1538), std::complex<double>(-0.0769, 1.0000),
		std::complex<double>(-0.0769, 0.8462), std::complex<double>(-0.0769, 0.6923),
		std::complex<double>(-0.0769, 0.5385), std::complex<double>(-0.0769, 0.3846),
		std::complex<double>(-0.0769, 0.2308), std::complex<double>(-0.0769, 0.0769),
